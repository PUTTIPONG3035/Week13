 ...
 <div class="container is-fluid mt-5">
  <div class="columns is-centered">
    ...
    <div class="column is-4">
      ...
      <p class="help is-danger" v-if="!$v.username.maxLength">username must be at least 20 letters</p>
    </template>
      </div>
      ...
      <p class="help is-danger" v-else-if="!$v.password.minLength">Password must be at least 8 letters</p>
      <p class="help is-danger" v-else-if="!$v.password.complexPassword">Password is too easy</p>
    </template>
      </div>
      ...
      <p class="help is-danger" v-else-if="!$v.mobile.mobile">Invalid Mobile Number</p>
    </template>
      </div>
      ...
      <p class="help is-danger" v-if="!$v.first_name.maxLength">firstName is must be 150 char</p>
    </template>
      </div>
      ...
      <p class="help is-danger" v-if="!$v.last_name.maxLength">firstName is must be 150 char</p>
    </template>
      </div>
